...
import vinyldns.java.handlers.ErrorResponseHandler;
import vinyldns.java.handlers.StringResponseHandler;
import vinyldns.java.serializers.SerializationFactory;
...
public class VinylDNSClientImpl implements VinylDNSClient {
    ...
    private <S, R> VinylDNSResponse<R> executeRequest(VinylDNSRequest<S> req, Class<R> responseType) {
        ...
        try {
            Response<String> response = client.requestExecutionBuilder()
