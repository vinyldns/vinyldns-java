...
public class ChangeInputDeserializer implements JsonDeserializer<SingleChange>, JsonSerializer<SingleChange> {
    ...
    @Override
    public SingleChange deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
        ...
        try {
            ...
            return context.deserialize(jsonObject, Class.forName(thepackage + type + SingleChange.class.getSimpleName()));
