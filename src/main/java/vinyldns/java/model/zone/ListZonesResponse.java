...
public class ListZonesResponse {
    ...
    /**
     * (optional) The startFrom parameter that was sent in on the HTTP request.
     * Will not be present if the startFrom parameter was not sent
     */
    private String startFrom;

    /**
     * (optional) The identifier to be passed in as the startFrom parameter to retrieve the next page of results.
     * If there are no results left, this field will not be present.
     */
    ...
    public ListZonesResponse(Collection<Zone> zones, String startFrom, String nextId, Integer maxItems, String nameFilter) {
        this.zones = zones;
