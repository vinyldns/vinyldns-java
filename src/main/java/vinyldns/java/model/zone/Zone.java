...
public class Zone {
    ...
    public Zone(String id, String name, String email, ZoneStatus status, DateTime created, DateTime updated,
                ZoneConnection connection, ZoneConnection transferConnection, boolean shared, ZoneACL acl,
                String adminGroupId, DateTime latestSync) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.status = status;
    ...
    public boolean equals(Object o) {
        ...
        if (connection != null ? !connection.equals(zone.connection) : zone.connection != null) return false;
        if (transferConnection != null ? !transferConnection.equals(zone.transferConnection) : zone.transferConnection != null)
            return false;
