...
public class ListZonesRequest {
    /**
     * One or more characters contained in the name of the zone to search for. For example www-.
     * This is a contains search only, no wildcards or regular expressions are supported
     */
    ...
    public boolean equals(Object o) {
        ...
        if (nameFilter != null ? !nameFilter.equals(that.nameFilter) : that.nameFilter != null) return false;
