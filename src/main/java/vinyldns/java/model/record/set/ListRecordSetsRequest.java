...
public class ListRecordSetsRequest {
    ...
    /**
     * One or more characters contained in the name of the record set to search for.
     * For example comcast. This is a contains search only, no wildcards or regular expressions are supported
     */
    private String recordNameFilter;

    /**
     * In order to advance through pages of results, the startFrom is set to the nextId that is returned on
     * the previous response. It is up to the client to maintain previous pages if the client wishes to advance
     * forward and backward. If not specified, will return the first page of results
     */
    ...
    public ListRecordSetsRequest(String zoneId, String recordNameFilter, String startFrom, Integer maxItems) {
        this.zoneId = zoneId;
        this.recordNameFilter = recordNameFilter;
    ...
    public boolean equals(Object o) {
        ...
        if (recordNameFilter != null ? !recordNameFilter.equals(that.recordNameFilter) : that.recordNameFilter != null)
            return false;
