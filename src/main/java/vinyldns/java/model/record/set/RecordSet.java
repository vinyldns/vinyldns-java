...
public class RecordSet extends RecordSetBase {
    ...
    /**
     * Active - RecordSet is added is created and ready for use, Inactive - RecordSet effects are not applied,
     * Pending - RecordSet is queued for creation, PendingUpdate - RecordSet is queued for update,
     * PendingDelete - RecordSet is queued for delete
     */
    ...
    public RecordSet(String zoneId, String name, RecordType type, long ttl, Collection<RecordData> records,
                     String id, RecordSetStatus status, DateTime created, DateTime updated) {
