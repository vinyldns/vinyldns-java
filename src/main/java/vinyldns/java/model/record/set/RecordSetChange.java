...
import vinyldns.java.model.zone.Zone;
...
public class RecordSetChange {
    ...
    public RecordSetChange(String id, Zone zone, RecordSet recordSet, String userId, RecordSetChangeType changeType,
                           RecordSetChangeStatus status, DateTime created, String systemMessage, RecordSet updates) {
        this.id = id;
        this.zone = zone;
    ...
    public boolean equals(Object o) {
        ...
        if (systemMessage != null ? !systemMessage.equals(that.systemMessage) : that.systemMessage != null)
            return false;
