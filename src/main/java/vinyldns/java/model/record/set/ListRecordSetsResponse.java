...
public class ListRecordSetsResponse {
  /**
   * refer to recordset model, the RecordSet data will also include the accessLevel the requesting
   * user has based off acl rules and membership in Zone Admin Group
   */
  ...
  /**
   * nextId, used as startFrom parameter of next page request, will not be returned if record sets
   * are exhausted
   */
  ...
  public boolean equals(Object o) {
    ...
    return recordNameFilter != null
        ? recordNameFilter.equals(that.recordNameFilter)
        : that.recordNameFilter == null;
  }
