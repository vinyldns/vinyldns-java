...
public class VinylDNSClientTest {
    ...
    public void beforeAll() {
        ...
        client = new VinylDNSClientImpl(new VinylDNSClientConfig("http://localhost:" + wireMockServer.port(),
    ...
    public void listZonesSuccessWithParams() {
        ...
        wireMockServer.stubFor(get(urlMatching("/zones?(.*)"))
        ...
        VinylDNSResponse<ListZonesResponse> vinylDNSResponse = client.listZones(new ListZonesRequest(nameFilter, startFrom, maxItems));
    ...
    public void listZonesSuccess() {
        ...
        wireMockServer.stubFor(get(urlEqualTo("/zones"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
                        .withBody(response)));
    ...
    public void listRecordSetsSuccessWithParams() {
        ...
        wireMockServer.stubFor(get(urlMatching("/zones/" + zoneId + "/recordsets?(.*)"))
        ...
        VinylDNSResponse<ListRecordSetsResponse> vinylDNSResponse = client.listRecordSets(new ListRecordSetsRequest(zoneId, recordNameFilter, startFrom, maxItems));
    ...
    public void listRecordSetsSuccess() {
        ...
        wireMockServer.stubFor(get(urlEqualTo("/zones/" + zoneId + "/recordsets"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
                        .withBody(response)));
        ...
        VinylDNSResponse<ListRecordSetsResponse> vinylDNSResponse = client.listRecordSets(new ListRecordSetsRequest(zoneId));
    ...
    public void deleteRecordSetsSuccess() {
        ...
        wireMockServer.stubFor(delete(urlEqualTo("/zones/" + zoneId + "/recordsets/" + recordSetId))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
                        .withBody(response)));
        ...
        VinylDNSResponse<RecordSetChange> vinylDNSResponse = client.deleteRecordSet(new DeleteRecordSetRequest(zoneId, recordSetId));
    ...
    public void createRecordSetsSuccess() {
        ...
        wireMockServer.stubFor(post(urlEqualTo("/zones/" + zoneId + "/recordsets"))
                .willReturn(aResponse()
                        .withStatus(202)
                        .withBody(request)
                        .withHeader("Content-Type", "application/json")
        ...
        VinylDNSResponse<RecordSetChange> vinylDNSResponse = client.createRecordSet(createRecordSetRequest);
    ...
    private ZoneConnection testZoneConnection1 = new ZoneConnection("name", "keyName", "key", "server");
    private ZoneACL testZoneAcl1 = new ZoneACL(Collections.singleton(
            new ACLRule(AccessLevel.Read, "description", "userId", "groupId", "recordMask", Collections.singleton(RecordType.A))
    ));
    private Zone testZone1 = new Zone("id", "name", "some@company.com", ZoneStatus.Active, new DateTime(), new DateTime(),
            testZoneConnection1,null, true, testZoneAcl1, "group", null);
    private List<Zone> zones = Collections.singletonList(testZone1);
    private ListZonesResponse listZonesResponse = new ListZonesResponse(zones, "startFrom", "nextId", 100, "nameFilter");
    ...
    private RecordSet recordSet = new RecordSet(zoneId, recordSetName, RecordType.A, 100,
            recordDataList, recordSetId,
            RecordSetStatus.Active, new DateTime(), new DateTime());
    private List<RecordSet> recordSetList = Collections.singletonList(recordSet);

    private ListRecordSetsResponse listRecordSetsResponse = new ListRecordSetsResponse(recordSetList, "startFrom", "nextId", 22, "nameFilter");

    private String recordSetChangeId = "recordSetChangeId";
    private RecordSetChange recordSetChangeDelete = new RecordSetChange(
            recordSetChangeId, testZone1, recordSet, "userId", RecordSetChangeType.Delete, RecordSetChangeStatus.Pending,
            new DateTime(), null, null
    );
    private RecordSetChange recordSetChangeCreate = new RecordSetChange(
            recordSetChangeId, testZone1, recordSet, "userId", RecordSetChangeType.Create, RecordSetChangeStatus.Pending,
            new DateTime(), null, null
    );
    private CreateRecordSetRequest createRecordSetRequest = new CreateRecordSetRequest(zoneId, recordSetName, RecordType.A, 100, recordDataList);
}
